    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      >
        <div class="relative drop-shadow-2">
          <img src="@/assets/images/user/user-01.png" alt="profile" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">Aitali Yassir </h3>
        <div
        ...
        >
          ...
          >
            <span class="font-semibold text-black dark:text-white">25</span>
            <span class="text-sm">chi l3iba</span>
          </div>
          <div
            class="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row"
          >
            <span class="font-semibold text-black dark:text-white">109</span>
            <span class="text-sm">chi l3iba</span>
          </div>
          <div class="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
            <span class="font-semibold text-black dark:text-white">20</span>
            <span class="text-sm">chi l3iba</span>
          </div>
        </div>
      </div>
